package com.lightwing.pay;

import com.lightwing.pay.impl.WeChatApiResultImpl;
import com.lightwing.pay.impl.WeChatPayApiImpl;
import com.lightwing.utility.HttpClientUtil;
...
public class Pay {
    ...
    public static void main(String[] s) {
        try {
            WeChatPayApiImpl p = new WeChatPayApiImpl("输入商户key");
            p.setAppid(""); // 公众号
            p.setMch_id(""); // 商户号
            ...
            WeChatApiResultImpl wxres = new WeChatApiResultImpl(in);
