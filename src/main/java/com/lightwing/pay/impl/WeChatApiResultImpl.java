...
/**
 * Created by Lightwing Ng
 */
public class WeChatApiResultImpl {
     ...
     * @param inputStream
     */
    public WeChatApiResultImpl(InputStream inputStream) throws DocumentException {
        super();
    ...
    public String getResult_code() {
        return this.map.get("result_code");
    }
    ...
    public String getErr_code_des() {
        return this.map.get("err_code_des");
    }
    ...
    public String getTrade_type() {
        return this.map.get("trade_type");
    }
